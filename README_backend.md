...
A FastAPI-based backend service for League of Legends data analysis, built for the Rift Rewind hackathon. This service provides a comprehensive REST API that interfaces with Riot Games' API to fetch player statistics, match history, champion information, and game assets.
...
| Endpoint | Method | Rate Limit | Description |
|----------|--------|------------|-------------|
| `/game_assets/get_lol_champions` | GET | 10/min | Get champion data from Data Dragon |
| `/game_assets/get_lol_items` | GET | 10/min | Get item information and statistics |
| `/game_assets/get_champion_abilities` | GET | 15/min | Get detailed champion abilities, stats, and tips |
...
```bash
curl "http://localhost:8000/game_assets/get_champion_abilities?champion_name=Jinx&include_stats=true"
```
